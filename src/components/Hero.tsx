  ...
  return (
    ...
    >
      ...
      <div className={`relative z-10 text-center px-6 max-w-5xl mx-auto transition-all duration-1000 ${
        ...
        {/* Description */}
        <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in-up animation-delay-600">
        ...
        {/* Social Links */}
        <div className="flex justify-center space-x-6 mb-16 animate-fade-in-up animation-delay-1000">
          {[
      ...
      {/* Custom CSS for Animations - FIX: Removed 'jsx' attribute */}
      <style>{`
        @keyframes float {
